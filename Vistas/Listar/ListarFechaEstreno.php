                ...
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Listar Fecha Estreno</li>
                        </ol>
                    </nav>
                    <div class="row">
                        <div class="col-12">
                            <form name="frmListarFecha" action="../../controlador.php" method="POST">
                                <div class="panel_blanco_filtro">
                                    <div class="row">
                                        <div class="col-12">
                                            <?php
                                            $anos = array("2019", "2020", "2021");
                                            $anos[] = "Todos";
                                            ?>

                                            <?php
                                            foreach ($anos as $ano) {
                                                echo '<input type="submit" class="btn btn-danger" name="estreno" id="estreno" value="' . $ano . '" >  ';
                                            }
                                            ?>
                                        </div>
                                    </div>
