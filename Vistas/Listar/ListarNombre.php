...
//                    include '../../Vistas/MenuDesplegable/menu_desplegable_registrados.php';
                ...
                include '../../Vistas/Headers/cabecera_vacia.php';
//                include '../../Vistas/menu_desplegable_no_registro.php';
            }
            ?>
            <!--Miga de pan-->
            <div class="row">
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Listar Nombre</li>
                        </ol>
                    </nav>
                    <div class="row">
                        <div class="col-12">
                            <form name="frmListarNombre" action="../../controlador.php" method="POST">
                                <div class="panel_blanco_filtro">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <?php
                                            foreach ($alphas as $letra) {
                                                echo '<input type="submit" class="btn btn-danger" name="letra" id="letra" value="' . $letra . '" >  ';
                                            }
                                            echo '<br>';
                                            foreach ($numeros as $numero) {
                                                echo '<input type="submit" class="btn btn-danger" name="numero" id="numero" value="' . $numero . '" >  ';
                                            }
                                            ?>
                                        </div>
                                    </div>
