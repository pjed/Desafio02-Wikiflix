            ...
            <div id="navbarContent" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownMenu1" class="dropdown-menu border-0 shadow animate slideIn">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownMenu1" class="dropdown-menu border-0 shadow animate slideIn">
                            ...
                            <li><a href="../../Vistas/Administrador/valida_peliculas.php" class="dropdown-item" hidden>Validar Película</a></li>
                            <!-- End Level two -->
                        </ul>
                    </li>
                    <!-- End Level one -->
