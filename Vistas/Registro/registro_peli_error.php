                ...
                <div class="row h-100 justify-content-center align-items-center">
                    <div class="col-4">
                        <form name="frmRegistro" action="../../controlador.php" method="POST">
                            <h3 class="white centrado">Registro erróneo ya existe la película</h3>
                            <br>
                            <div class="container-fluid"> 
                                <div class="row align-items-center">
                                    <div class="col text-center">
                                        <a href="../Registro/registro_peli.php"><button type="button" class="btn btn-danger">Volver</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
